...
let mySprite2 = sprites.create(img`
    ...
    `, SpriteKind.Player)
game.splash("you are OIRAM, and you must retrieve the key in the ancient chest of Quack")
game.showLongText("use the arrow keys to move & jump", DialogLayout.Bottom)
gottem = 0
pointingLeft = 0
